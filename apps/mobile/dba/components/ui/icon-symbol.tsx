...
// expo-symbols (SDK 57) allows a per-platform object for `name`; only the
// plain SF Symbol string names are valid Record keys.
 ...
 * Android and web. This ensures a consistent look across platforms, and
